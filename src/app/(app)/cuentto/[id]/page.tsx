  ...
  return (
    <div className="flex flex-col gap-[30px] w-full py-[60px] px-[110px]">
      ...
      <div className="pt-[40px] flex flex-col gap-[50px] ">
        ...
        <span className="w-[236px] h-[40px] rounded-[200px] bg-light-violet flex flex-row justify-center items-center gap-[10px]">
          <p className="text-[14px] font-medium text-black">
      ...
      <div className="flex flex-row justify-between items-center mt-[20px]">
        <div className="flex items-center cursor-pointer gap-[15px]">
          <CommentIcon
            width={18}
            height={18}
            color="black"
